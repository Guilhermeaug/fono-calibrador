  ...
  return (
    <main className="mx-auto max-w-[850px] px-8 pt-16">
      ...
      <TypographyP>
        ...
        <b>Teste do Processamento Auditivo (PAC)</b>. Para realizá-lo, basta clicar no botão abaixo.
        Você será direcionado ao site AudBility, onde realizará o teste.
      </TypographyP>
      <TypographyP className="font-bold">
        Importante: após realizar o teste, é necessário retornar nesta página e assinar virtualmente
        o Termo de Conclusão do PAC abaixo para prosseguir para a última etapa, o Treinamento de
