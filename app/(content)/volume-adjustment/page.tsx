...
export default function VolumeAdjustmentPage() {
  return (
    <main className="mx-auto max-w-[850px] px-8 pt-20">
      ...
      <TypographyP>
        Ajuste o volume do seu computador até que reconheça corretamente o som
        que aparece ao fundo da voz. Após responder corretamente e ser liberado
        dessa etapa, não faça alterações no volume.
      </TypographyP>
      <TypographyP>
